...
|---|---|
| [`00_quickstart.py`](00_quickstart.py) | The `Agent` facade — one object, one `run()` call. Start here. |
...
Example 00 defaults to Anthropic; for the others, change the `model=` line.
